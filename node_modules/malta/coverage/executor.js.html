...
<head>
    <title>Code coverage report for executor.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> executor.js</h1>
        <div class='clearfix'>
...
&nbsp;
        if (this.iterator.hasNext()) {
            const ext = this.iterator.next(),
                pins = this.pm.plugins[ext] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
...
&nbsp;
                                ...
                                go();
                            }).catch(<span class="fstat-no" title="function not covered" >ms</span>g =&gt; {
