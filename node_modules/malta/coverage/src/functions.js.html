...
<head>
    <title>Code coverage report for src/functions.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> functions.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >                    throw err;</span>
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (files) {
                    files.forEach(file =&gt; {
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (!exclude(file) &amp;&amp; file.match(new RegExp(`.*\\.${ext}$`))) {
                            // store the process
                            ++processNum;
            ...
            if (!noDemon) {
                watcher.observe(folder, (diff, extension) =&gt; {
                    diff.added.filter(function (v) {
                        ...
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (exclude(v)) <span class="cstat-no" title="statement not covered" >return;</span>
                        ++processNum;
...
&nbsp;
                    diff.removed.filter(v =&gt; {
                        ...
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (fs.existsSync(outFile)) fs.unlink(outFile, () =&gt; { });
