...
<head>
    <title>Code coverage report for src/observe.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> observe.js</h1>
        <div class='clearfix'>
...
<a name='L88'></a><a href='#L88'>88</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">33x</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!(extension in elements[folder])) {
        ...
        elements[folder][extension] = setInterval(() =&gt; {
            try {
                fs.readdir(folder, function (err, files) {
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!files) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
                    if (!previous) {
                        previous = {
                            files: files,
...
<span class="cstat-no" title="statement not covered" >                Malta.log_debug(err);</span>
...
&nbsp;
    function unobserve (folder, extension) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (folder in elements) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (extension in elements[folder]) {
