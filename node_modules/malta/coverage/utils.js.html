...
&nbsp;
        let i = 0;
        ctx = (ctx !== undefined) ? ctx : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
        if (!ns) return ctx;
        for (null; i &lt; l; i += 1) {
...
&nbsp;
    ...
    isArray = o =&gt; {
        ...
        return t1 &amp;&amp; !!(t2 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >t2.length)</span>;
    },
&nbsp;
    /**
        ...
        while (straight) {
            ...
            tpl = tpl.replace(reg, (str, enc, $1, _t) =&gt; {
                if (typeof obj === 'function') {
                    ...
                    tmp = obj($1);
                    _t = (tmp !== start + $1 + end) ? obj($1) : <span class="branch-1 cbranch-no" title="branch not covered" >$1;</span>
                } else if ($1 in obj) {
                    _t = typeof obj[$1];
                    if (_t === 'function') {
                        _t = obj[$1]($1);
...
&nbsp;
                    ...
                    */
                    if ($1.match(/\./)) {
                        last = checkns($1, obj);
                        if (last) {
                            _t = enc ? <span class="branch-0 cbranch-no" title="branch not covered" >encodeURIComponent(last) </span>: last;
                            return typeof last === 'function' ? last($1) : last;
                        }
                    }
                    // but do not go deeper
                    straight = false;
                    _t = fb !== null ? fb($1) : clean ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: start + $1 + end;
                }
                return enc ? <span class="branch-0 cbranch-no" title="branch not covered" >encodeURIComponent(_t) </span>: _t;
            });
        }
        return tpl;
    },
                ...
                switch (typeof o[j]) {
                    case 'string':
                        ...
                        while (y) {
                            o[j] = o[j].replace(
                                `$${y[1]}$`,
                                checkns(y[1], obj) || <span class="branch-1 cbranch-no" title="branch not covered" >''</span>
                            );
                            if (maxSub-- &lt; 0) {
