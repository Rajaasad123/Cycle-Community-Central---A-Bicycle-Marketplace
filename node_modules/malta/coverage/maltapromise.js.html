...
<html lang="en">
<head>
    <title>Code coverage report for maltapromise.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> maltapromise.js
    </h1>
    <div class='clearfix'>
...
function check (inst) {
    const self = inst;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!self.solved) {
        self.f(
            function () {
                self.solved = 1;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sun Mar 08 2020 00:18:25 GMT+0100 (CET)
</div>
</div>
